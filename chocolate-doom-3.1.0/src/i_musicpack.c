...
#ifdef STM32_DOOMPLAYER
char *music_pack_path = MUSIC_PACK_DIR;
#else
...
static const subst_music_t known_filenames[] = {
    // Doom 1 music files.
#ifdef STM32_DOOMPLAYER
    {"b2e05b4e8dff8d76f8f4", "d_inter.flac"},
    {"0c0acce45130bab935d2", "d_intro.flac"},
    {"fca4086939a68ae4ed84", "d_victor.flac"},
    {"5971e5e20554f47ca065", "d_intro.flac"},
    {"99767e32769229897f77", "d_e1m1.flac"},
    {"b5e7dfb4efe9e688bf2a", "d_e1m2.flac"},
    {"fda8fa73e4d30a6b961c", "d_e1m3.flac"},
    {"3805f9bf3f1702f7e7f5", "d_e1m4.flac"},
    {"f546ed823b234fe39165", "d_e1m5.flac"},
    {"4450811b5a6748cfd83e", "d_e1m6.flac"},
    {"73edb50d96b0ac03be34", "d_e1m7.flac"},
    {"47d711a6fd32f5047879", "d_e1m8.flac"},
    {"62c631c2fdaa5ecd9a8d", "d_e1m9.flac"},
    {"7702a6449585428e7185", "d_e2m1.flac"},
    {"1cb1810989cbfae2b29b", "d_e2m2.flac"},
    {"7d740f3c881a22945e47", "d_e2m4.flac"},
    {"ae9c3dc2f9aeea002327", "d_e2m6.flac"},
    {"b26aad3caa420e9a2c76", "d_e2m7.flac"},
    {"90f06251a2a90bfaefd4", "d_e2m8.flac"},
    {"b2fb439f23c08c8e2577", "d_e3m1.flac"},
    {"b6c07bb249526b864208", "d_e3m2.flac"},
    {"ce3587ee503ffe707b2d", "d_e3m3.flac"},
    {"d746ea2aa16b3237422c", "d_e3m8.flac"},
    {"3da3b1335560a92912e6", "d_bunny.flac"},

    // Duplicates that don't have identical hashes:
    {"4a5badc4f10a7d4ed021", "d_inter.flac"},  // E2M3
    {"36b14bf165b3fdd3958e", "d_e1m7.flac"},   // E3M5
    {"e77c3d42f2ea87f04607", "d_e1m6.flac"},   // E3M6
    {"3d85ec9c10b5ea465568", "d_e2m7.flac"},   // E3M7
    {"4d42e2ce1c1ff192500e", "d_e1m9.flac"},   // E3M9

    // These tracks are reused in Alien Vendetta, but are MIDs:
    {"a05e45f67e1b64733fe3", "d_e2m1.flac"},   // MAP02
    {"8024ae1616ddd97ce330", "d_e1m4.flac"},   // MAP03
    {"3af8d79ddba49edaf9eb", "d_victor.flac"}, // MAP05
    {"a55352c96c025b6bd08a", "d_inter.flac"},  // MAP07
    {"76d1fc25ab7b1b4a58d6", "d_e1m8.flac"},   // MAP11
    {"497777f0863eca7cea87", "d_e1m2.flac"},   // MAP12
    {"0228fd87f8762f112fb6", "d_e2m2.flac"},   // MAP13
    {"db94e8e1d7c02092eab5", "d_e1m6.flac"},   // MAP14
    {"5a8d7a307eebc952795c", "d_e2m7.flac"},   // MAP16
    {"1a36b692bf26d94a72cc", "d_e1m7.flac"},   // MAP23
    {"37c6cefa351b06995152", "d_e1m5.flac"},   // MAP27
    {"36b97b87fe98348d44b6", "d_e2m6.flac"},   // MAP28

    // Doom II music files.
    {"79080e9681a2d7bec3fb", "d_runnin.flac"},  // MAP01,15
    {"868b3aae73c7b12e92c0", "d_stalks.flac"},  // MAP02,11,17
    {"19237754d2eb85f41d84", "d_countd.flac"},  // MAP03,21
    {"00abff3b61b25a6855d2", "d_betwee.flac"},  // MAP04
    {"954636c7ee09edf5d98f", "d_doom.flac"},    // MAP05,13
    {"8d32b2b7aa3b806474c1", "d_the_da.flac"},  // MAP06,12,24
    {"41efc3c84bb321af2b6b", "d_shawn.flac"},   // MAP07,19,29
    // Assuming single D_DDTBLU: http://doomwiki.org/wiki/Doom_II_music#Trivia
    {"51c0872fec9f43259318", "d_ddtblu.flac"},  // MAP08
    {"acb7ad85494d18235df8", "d_ddtblu.flac"},  // MAP14,22
    {"4b7ceccbf47e78e2fa0b", "d_in_cit.flac"},  // MAP09
    {"1d1f4a9edba174584e11", "d_dead.flac"},    // MAP10,16
    {"1736c81aac77f9bffd3d", "d_romero.flac"},  // MAP18,27
    {"a55d400570ad255a576b", "d_messag.flac"},  // MAP20,26
    {"29d30c3fbd712016f2e5", "d_ampie.flac"},   // MAP23
    {"bcfe9786afdcfb704afa", "d_adrian.flac"},  // MAP25
    {"e05c10389e71836834ae", "d_tense.flac"},   // MAP28
    {"b779022b1d0f0010b8f0", "d_openin.flac"},  // MAP30
    {"a9a5f7b0ab3be0f4fc24", "d_evil.flac"},    // MAP31
    {"4503d155aafec0296689", "d_ultima.flac"},  // MAP32
    {"56f2363f01df38908c77", "d_dm2ttl.flac"},
    {"71e58baf9e9dea4dd24a", "d_dm2int.flac"},
    {"e632318629869811f7dc", "d_read_m.flac"},
    ...
    {"868b3aae73c7b12e92c0", "d_stlks2.flac"},
    {"868b3aae73c7b12e92c0", "d_stlks3.flac"},
    {"8d32b2b7aa3b806474c1", "d_theda2.flac"},
    {"8d32b2b7aa3b806474c1", "d_theda3.flac"},
    {"954636c7ee09edf5d98f", "d_doom2.flac"},
    {"acb7ad85494d18235df8", "d_ddtbl2.flac"},
    {"acb7ad85494d18235df8", "d_ddtbl3.flac"},
    {"79080e9681a2d7bec3fb", "d_runni2.flac"},
    {"1d1f4a9edba174584e11", "d_dead2.flac"},
    {"41efc3c84bb321af2b6b", "d_shawn2.flac"},
    {"41efc3c84bb321af2b6b", "d_shawn3.flac"},
    {"19237754d2eb85f41d84", "d_count2.flac"},
    {"a55d400570ad255a576b", "d_messg2.flac"},
    {"1736c81aac77f9bffd3d", "d_romer2.flac"},

    // These tracks are reused in Alien Vendetta, but are MIDs:
    {"9433604c098b7b1119a4", "d_in_cit.flac"},  // MAP26

    // Heretic tracks.
    {"12818ca0d3c957e7d57e", "mus_titl.flac"},
    {"5cb988538ce1b1857349", "mus_intr.flac"},
    {"6f126abe35a78b61b930", "mus_cptd.flac"},
    {"62557250f0427c067dc9", "mus_e1m1.flac"},
    {"1e8d5fd814490b9ae166", "mus_e1m2.flac"},
    {"f0f31e8834e85035d434", "mus_e1m3.flac"},
    {"054d6997405cc5a32b46", "mus_e1m4.flac"},
    {"31950ab062cc1e5ca49d", "mus_e1m5.flac"},
    {"7389024fbab0dff47211", "mus_e1m6.flac"},
    {"f2aa312dddd0a294a095", "mus_e1m7.flac"},
    {"cd6856731d1ae1f3aa4e", "mus_e1m8.flac"},
    {"d7fe793f266733d92e61", "mus_e1m9.flac"},
    {"933545b48fad8c66f042", "mus_e2m1.flac"},
    {"bf88ecd4ae1621222592", "mus_e2m2.flac"},
    {"4f619f87a828c2ca4801", "mus_e2m3.flac"},
    {"13033a83c49424b2f2ab", "mus_e2m4.flac"},
    {"b3851f9351ae411d9de3", "mus_e2m6.flac"},
    {"82539791159fbbc02a23", "mus_e2m7.flac"},
    {"fd9e53a49cfa62c463a0", "mus_e2m8.flac"},
    {"29503959324d2ca67958", "mus_e2m9.flac"},
    {"3aa632257c5be375b97b", "mus_e3m2.flac"},
    {"69ba0dce7913d53b67a8", "mus_e3m3.flac"},

    // These Heretic tracks are reused in Alien Vendetta, but are MIDs:
    {"51344131e8d260753ce7", "mus_e2m3.flac"},  // MAP15
    {"78b570b2397570440aff", "mus_e1m1.flac"},  // MAP19
    {"ee21ba9fad4de3dfaef0", "mus_e1m4.flac"},  // MAP29
    {"d2bb643a60696ccbca03", "mus_e1m9.flac"},  // MAP32

    // Hexen tracks:
    {"fbf55fc1ee26bd01266b", "winnowr.flac"},
    {"71776e2da2b7ba607d81", "jachr.flac"},
    {"c5c8630608b8132b33cd", "simonr.flac"},
    {"43683b3f55a031de88d4", "wutzitr.flac"},
    {"a6062883f29436ef73db", "falconr.flac"},
    {"512cb6cc9b558d5f0fef", "levelr.flac"},
    {"d31226ae75fce6a24208", "chartr.flac"},
    {"bf1f1e561bbdba4e699f", "swampr.flac"},
    {"b303193f756ca0e2de0f", "deepr.flac"},
    {"f0635f0386d883b00186", "fubasr.flac"},
    {"18f2a01f83df6e3abedc", "grover.flac"},
    {"b2527eb0522f08b2cf5f", "fortr.flac"},
    {"343addba8ba53a20a160", "foojar.flac"},
    {"c13109045b06b5a63386", "sixater.flac"},
    {"693525aaf69eac5429ab", "wobabyr.flac"},
    {"8f884223811c2bb8311d", "cryptr.flac"},
    {"de540e6826e62b32c01c", "fantar.flac"},
    {"efdff548df918934f71f", "blechr.flac"},
    {"de91f150f6a127e72e35", "voidr.flac"},
    {"e0497fe27289fe18515b", "chap_1r.flac"},
    {"f2ef1abdc3f672a3519a", "chap_2r.flac"},
    {"78cd9882f61cc441bef4", "chap_3r.flac"},
    {"97b2b575d9d096c1f89f", "chap_4r.flac"},
    {"ad0197a0f6c52ac30915", "chippyr.flac"},
    {"30506c62e9f0989ffe09", "percr.flac"},
    {"3542803beaa43bf1de1a", "secretr.flac"},
    {"81067721f40c611d09fb", "bonesr.flac"},
    {"4822af2e1a2eb7faf660", "octor.flac"},
    {"26bb3cec902ed8008fc2", "rithmr.flac"},
    {"94ab641c7aa93caac77a", "stalkr.flac"},
    {"d0a3f337c54b0703b4d3", "borkr.flac"},
    {"79e7781ec7eb9b9434b5", "crucibr.flac"},
    {"c2786e5581a7f8801969", "hexen.flac"},
    {"97fae9a084c0efda5151", "hub.flac"},
    {"c5da52d5c2ec4803ef8f", "hall.flac"},
    {"1e71bc0e2feafb06214e", "orb.flac"},
    {"bc9dcfa6632e847e03af", "chess.flac"},

    // Hexen CD tracks: alternate filenames for a ripped copy of
    // the CD soundtrack.
    {"71776e2da2b7ba607d81", "hexen02.flac"},   // level  2 (jachr)
    {"efdff548df918934f71f", "hexen03.flac"},   // level 26 (blechr)
    {"c2786e5581a7f8801969", "hexen04.flac"},   // (hexen)
    {"1e71bc0e2feafb06214e", "hexen05.flac"},   // (orb)
    {"f0635f0386d883b00186", "hexen06.flac"},   // level 10 (fubasr)
    {"bc9dcfa6632e847e03af", "hexen07.flac"},   // (chess)
    {"8f884223811c2bb8311d", "hexen08.flac"},   // level 24 (cryptr)
    {"a6062883f29436ef73db", "hexen09.flac"},   // level  5 (falconr)
    {"4822af2e1a2eb7faf660", "hexen10.flac"},   // level 36 (octor)
    {"26bb3cec902ed8008fc2", "hexen11.flac"},   // level 37 (rithmr)
    {"c13109045b06b5a63386", "hexen12.flac"},   // level 22 (sixater)
    {"fbf55fc1ee26bd01266b", "hexen13.flac"},   // level  1 (winnowr)
    {"bf1f1e561bbdba4e699f", "hexen14.flac"},   // level  8 (swampr)
    {"43683b3f55a031de88d4", "hexen15.flac"},   // level  4 (wutzitr)
    {"81067721f40c611d09fb", "hexen16.flac"},   // level 35 (bonesr)
    {"e0497fe27289fe18515b", "hexen17.flac"},   // level 28 (chap_1r)
    {"97b2b575d9d096c1f89f", "hexen18.flac"},   // level 31 (chap_4r)
    {"de540e6826e62b32c01c", "hexen19.flac"},   // level 25 (fantar)
    {"343addba8ba53a20a160", "hexen20.flac"},   // level 21 (foojar)
    {"512cb6cc9b558d5f0fef", "hexen21.flac"},   // level  6 (levelr)
    {"c5c8630608b8132b33cd", "hexen22.flac"},   // level  3 (simonr)

    // Strife:
    {"8ac2b2b47707f0fdf8f6", "d_logo.flac"},   // Title
    {"62e1c58054a1f1bc39b2", "d_action.flac"}, // 1,15,28
    {"12fa000f3fa1edac5c4f", "d_tavern.flac"}, // 2
    {"695e56ab3251792d20e5", "d_danger.flac"}, // 3,11
    {"96fe30e8712217b60dd7", "d_fast.flac"},   // 4
    {"61345598a3de04aad508", "d_darker.flac"}, // 6,14
    {"52353e9a435b7b1cb268", "d_strike.flac"}, // 7,19
    {"061164504907bffc9c22", "d_slide.flac"},  // 8,18,22
    {"3dbb4b703ce69aafcdd5", "d_tribal.flac"}, // 9
    {"393773688eba050c3548", "d_march.flac"},  // 10
    {"3cba3c627de065a667dd", "d_mood.flac"},   // 12
    {"b1f65a333e5c70255784", "d_castle.flac"}, // 13
    {"e1455a83a04c9ac4a09f", "d_fight.flac"},  // 16,31
    {"17f822b7374b1f069b89", "d_spense.flac"}, // 17
    {"e66c5a1a7d05f021f4ae", "d_dark.flac"},   // 20
    {"1c92bd0625026af30dad", "d_tech.flac"},   // 21,27
    {"7ae280713d078de7933a", "d_drone.flac"},  // 23,30
    {"4a664afd0d7eae79c97a", "d_panthr.flac"}, // 24
    {"4a7d62beeac5601ccf21", "d_sad.flac"},    // 25
    {"e60e109779400f2855d7", "d_instry.flac"}, // 26,29
    {"b7d36878faeb291d6df5", "d_happy.flac"},  // Better ending
    {"ff4a342c8c5ec51b06c3", "d_end.flac"},    // Worse ending
    // This conflicts with Doom's d_intro:
    //{"ec8fa484c4e85adbf700", "d_intro.flac"},  // 5
#else
...
#ifdef STM32_DOOMPLAYER
static char subst_filename[40];

const char *GetSubstituteMusicFile(void *data, size_t data_len)
{
    ...
    subst_music_len = sizeof(known_filenames) / sizeof(subst_music_t);
    filename = NULL;

    for (i = 0; i < subst_music_len; ++i)
    {
        if (M_StringStartsWith(hash_str, known_filenames[i].hash_prefix))
        {
            M_snprintf(subst_filename, sizeof(subst_filename)-1, "%s/%s",
               MUSIC_PACK_DIR, known_filenames[i].filename);
            filename = M_StringDuplicate(subst_filename);
...
static void I_MP_PlaySong(void *handle, boolean looping)
{
    ...
    {
#ifdef STM32_DOOMPLAYER
        debug_printf("I_MP_PlaySong: Error starting track:\n");
#else
...
#ifdef STM32_DOOMPLAYER
    Mix_PauseMusic(current_track_music);
#else
    Mix_PauseMusic();
#endif
}
...
#ifdef STM32_DOOMPLAYER
    Mix_ResumeMusic(current_track_music);
#else
    Mix_ResumeMusic();
#endif
}
...
static void *I_MP_RegisterSong(void *data, int len)
{
    ...
    if (music == NULL)
    {
        ...
        // message.
#ifdef STM32_DOOMPLAYER
        debug_printf("Failed to load substitute music file: %s\n", filename);
#else
