...
DOOM_UART_Handle bt600_uart;
DOOM_UART_Handle shell_uart;
DOOM_OSPI_Handle flash_ospi;
DOOM_OSPI_Handle psram_ospi;
...
/* Configure the peripherals common clocks */
  ...
  haldev->bt_uart = &bt600_uart;
  haldev->bt_uart->huart = &huart2;
  haldev->bt_uart->huart->UserPointer = (void *)haldev->bt_uart;

  haldev->shell_uart = &shell_uart;
  haldev->shell_uart->huart = &huart1;
  haldev->shell_uart->huart->UserPointer = (void *)haldev->shell_uart;

  haldev->touch_i2c = &touch_i2c;
  haldev->touch_i2c->hi2c = &hi2c1;
  haldev->touch_i2c->hi2c->UserPointer = (void *)haldev->touch_i2c;

  haldev->codec_i2c = &codec_i2c;
  haldev->codec_i2c->hi2c = &hi2c2;
  haldev->codec_i2c->hi2c->UserPointer = (void *)haldev->codec_i2c;

  haldev->qspi_flash = &flash_ospi;
  haldev->qspi_flash->hospi = &hospi1;
  haldev->qspi_flash->hospi->UserPointer = (void *)haldev->qspi_flash;
  haldev->qspi_psram = &psram_ospi;
  haldev->qspi_psram->hospi = &hospi2;
  haldev->qspi_psram->hospi->UserPointer = (void *)haldev->qspi_psram;

  haldev->tft_lcd = &tft_lcd;
  ...
  haldev->audio_sai->hsai->UserPointer = (void *)haldev->audio_sai;

  haldev->comp_hash = &comp_hash;
  haldev->comp_hash->hhash = &hhash;
  haldev->comp_hash->hhash->UserPointer = (void *)haldev->comp_hash;
...
void PeriphCommonClock_Config(void)
{
  ...
  */
  ...
  PeriphClkInit.PLL3.PLL3N = 21;
  PeriphClkInit.PLL3.PLL3P = 30;
  PeriphClkInit.PLL3.PLL3Q = 2;
  PeriphClkInit.PLL3.PLL3R = 2;
  PeriphClkInit.PLL3.PLL3RGE = RCC_PLLVCIRANGE_1;
  PeriphClkInit.PLL3.PLL3FRACN = 1380;
...
static void MX_TIM3_Init(void)
{
  ...
  htim3.Instance = TIM3;
  htim3.Init.Prescaler = LED_PWM_PRESCALER;
...
static void MX_TIM15_Init(void)
{
  ...
  htim15.Init.Prescaler = PWM_PRESCALER;
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  GPIO_InitStruct.Pin = TEST0_Pin | TEST1_Pin;
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, BT_RESET_Pin|LED_GREEN_Pin, GPIO_PIN_RESET);
  ...
  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(EXTI13_IRQn, 12, 0);
  HAL_NVIC_EnableIRQ(EXTI13_IRQn);

  HAL_NVIC_SetPriority(EXTI15_IRQn, 9, 0);
