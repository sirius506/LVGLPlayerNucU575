#ifndef DSHOCK4_REPORT_H
#define DSHOCK4_REPORT_H
...
struct ds4_imu_calibration_data {
    int16_t bias;
    float sensitivity;
};
...
struct ds4_data {
    ...
    struct ds4_imu_calibration_data accel_calib_data[3];
    struct ds4_imu_calibration_data gyro_calib_data[3];
};
